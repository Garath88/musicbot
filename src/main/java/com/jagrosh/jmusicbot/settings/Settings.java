...
public class Settings implements GuildSettingsProvider {
    ...
    private boolean singleRepeatMode;
    ...
    public void setRepeatModeSingle(boolean singleRepeatMode) {
        this.singleRepeatMode = singleRepeatMode;
    }

    public boolean getRepeatModeSingle() {
        return this.singleRepeatMode;
    }
}
